...
public interface WdMethods {
		...
		/**
		 * This Method will create explicity wait delay until an element is clickable using xpath
		 * @author Raghavan
		 * 
		 */
		...
		/**
		 * This Method will create explicity wait delay until an element is visible using id/classname
		 * @author Raghavan
		 * 
		 */
		...
		/**
		 * This Method will allow the user to switch to frame by ID or name
		 * @author Raghavan
		 * 
		 */		
		...
		/**
		 * This Method will return the attribute value of the given attribute name in the web element
		 * @author Raghavan
		 * 
		 */	
